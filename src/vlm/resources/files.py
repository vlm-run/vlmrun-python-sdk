...
from ..types.store_file_response import StoreFileResponse
        ...
        *,
        ...
        return self._post(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"purpose": purpose}, file_create_params.FileCreateParams),
            ),
            cast_to=StoreFileResponse,
        )
        ...
        *,
        ...
        return await self._post(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"purpose": purpose}, file_create_params.FileCreateParams),
            ),
            cast_to=StoreFileResponse,
        )
