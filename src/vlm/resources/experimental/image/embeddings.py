...
from ....types.experimental.image import embedding_create_params
    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          batch: Whether to process the image/text in batch mode (async).
          ...
          image: Base64 encoded image to embed (at least one of `image` or `text` is required).

          metadata: Metadata for the request.

          model: The model to use for generating the response.

          text: Text to embed (at least one of `image` or `text` is required).
        ...
        """
        return self._post(
            "/v1/experimental/image/embeddings",
