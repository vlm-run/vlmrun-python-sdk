...
from vlm import Vlm, AsyncVlm, APIResponseValidationError
from vlm._types import Omit
from vlm._models import BaseModel, FinalRequestOptions
from vlm._constants import RAW_RESPONSE_HEADER
from vlm._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from vlm._base_client import DEFAULT_TIMEOUT, HTTPX_DEFAULT_TIMEOUT, BaseClient, make_request_options
...
def _get_open_connections(client: Vlm | AsyncVlm) -> int:
...
class TestVlm:
    client = Vlm(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, client: Vlm) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(VLM_BASE_URL="http://localhost:5000/from/env"):
            client = Vlm(bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: Vlm) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Vlm) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Vlm) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Vlm(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Vlm(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    @mock.patch("vlm._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/v1/openai/chat/completions").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.post(
                "/v1/openai/chat/completions",
                body=cast(object, dict(messages=[{}])),
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/v1/openai/chat/completions").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/v1/openai/chat/completions").mock(side_effect=retry_handler)

        response = client.openai.chat_completions.with_raw_response.create(messages=[{}])
    ...
    @mock.patch("vlm._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_omit_retry_count_header(self, client: Vlm, failures_before_success: int, respx_mock: MockRouter) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.openai.chat_completions.with_raw_response.create(
            messages=[{}], extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        self, client: Vlm, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.openai.chat_completions.with_raw_response.create(
            messages=[{}], extra_headers={"x-stainless-retry-count": "42"}
        )
...
class TestAsyncVlm:
    client = AsyncVlm(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncVlm) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(VLM_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncVlm(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncVlm) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncVlm) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncVlm) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncVlm(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncVlm(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        ...
        response = await client.openai.chat_completions.with_raw_response.create(messages=[{}])
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncVlm, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.openai.chat_completions.with_raw_response.create(
            messages=[{}], extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_get_platform(self) -> None:
        ...
        from vlm._utils import asyncify
        from vlm._base_client import get_platform 
