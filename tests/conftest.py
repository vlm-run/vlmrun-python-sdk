...
def mock_client(monkeypatch):
    ...
    class MockClient:
        ...
        def list_files(self):
            return [{"id": "file1", "filename": "test.txt", "size": 100, "created_at": "2024-01-01"}]
        ...
        def list_fine_tuning_jobs(self):
            return [{"id": "job1", "model": "test-model", "status": "running", "created_at": "2024-01-01"}]
        ...
        def list_models(self):
            return [{"id": "model1", "name": "Test Model", "description": "A test model"}]
        ...
        def list_hub_items(self):
            return [{"id": "item1", "name": "Test Item", "type": "model", "version": "1.0.0"}]
