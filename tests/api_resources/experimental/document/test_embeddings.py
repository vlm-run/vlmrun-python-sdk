...
class TestEmbeddings:
    ...
    def test_method_create(self, client: Vlm) -> None:
        embedding = client.experimental.document.embeddings.create()
    ...
    def test_raw_response_create(self, client: Vlm) -> None:
        response = client.experimental.document.embeddings.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: Vlm) -> None:
        with client.experimental.document.embeddings.with_streaming_response.create() as response:
...
class TestAsyncEmbeddings:
    ...
    async def test_method_create(self, async_client: AsyncVlm) -> None:
        embedding = await async_client.experimental.document.embeddings.create()
        assert_matches_type(PredictionResponse, embedding, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncVlm) -> None:
        response = await async_client.experimental.document.embeddings.with_raw_response.create()
    ...
    async def test_streaming_response_create(self, async_client: AsyncVlm) -> None:
        async with async_client.experimental.document.embeddings.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
