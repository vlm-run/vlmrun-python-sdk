...
def test_list_predictions(runner, mock_client):
...
def test_list_predictions_with_status_filter(runner, mock_client):
...
def test_get_prediction(runner, mock_client):
...
def test_get_prediction_with_wait(runner, mock_client):
    ...
    assert "test" in result.stdout  # response content


def test_get_prediction_usage_display(runner, mock_client):
...
def test_list_predictions_table_format(runner, mock_client):
